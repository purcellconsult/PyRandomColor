...
# You can pick random colors, or select colors
# of a similar shade.
#
# Color names taken from: https://ecsdtech.com/8-pages/121-python-turtle-colors
#
#
#
#####################################################################
...
turtle_colors = [
    ...
    'mediumaquamarine', 'aquamarine', 'darkgreen',
